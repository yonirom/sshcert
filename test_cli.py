...
class TestCli(unittest.TestCase):
    ...
    def test_update_user(self):
        ...
        # First, create a user
        self.runner.invoke(cli, ['--config-file', self.config_file, 'create', 'testuser', '--password', 'oldpass'])
    ...
    def test_delete_user(self):
        ...
        # First, create a user
        self.runner.invoke(cli, ['--config-file', self.config_file, 'create', 'testuser', '--password', 'somepass'])

        # Now, delete the user
        result = self.runner.invoke(cli, ['--config-file', self.config_file, 'delete', 'testuser'])
        self.assertEqual(result.exit_code, 0)
